...
function minimax(tableroTemporal, profundidad) {
    ...
    var movimiento, jugeoPosible;
    for(var i=0; i < movimientosPosibles.length; i++) {
	movimiento = movimientosPosibles[i];
        jugeoPosible = getNuevoEstado(movimiento, tableroTemporal);
        puntuaciones.push(minimax(jugeoPosible, profundidad));
